...
Table \ref{tab:bonf_cover_1000} presents coverage probabilities in percentage point for the full simulation grid, while Figures \ref{fig:bonf_point5_1000}--\ref{fig:bonf_3_1000} plot coverage functions (1 - Power) at selected parameter values.
...
In spite of this conservatism, the Bonferroni interval is still informative, as we see from Figures \ref{fig:bonf_point5_1000}--\ref{fig:bonf_3_1000}.
For smaller values of $(\alpha_0, \alpha_1)$ and larger values of 
