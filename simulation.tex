...
A drawback of the identification-robust inference procedure from Algorithm \ref{alg:Bonferroni} becomes apparent when both $\beta$ and the mis-classification probabilities are large.
