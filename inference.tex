...
\todo[inline]{Suppose iid observations. Then standard conditions get a joint CLT. Now the asymptotic variance we need is BLAH, while is constructed from the FULL variance matrix THIS WAY and we define the following estimators. END OF SECTION!}
