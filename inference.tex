...
\begin{alg}[GMS Test for $\alpha_0$ and $\alpha_1$ ]
  \mbox{} \\
  \textbf{Inputs:} null hypothesis $H_0\colon\boldsymbol{\vartheta} = \boldsymbol{\vartheta}_0$ for $(\alpha_0, \alpha_1)$, draws $\zeta_1, \cdots, \zeta_R \sim \mbox{ iid } N(\mathbf{0}, \mathbf{I}_J)$
  \begin{enumerate}
    ...
    \item Calculate the test statistic $T_n(\boldsymbol{\vartheta}_0)$.
      \begin{enumerate}[(i)]
        ...
        \item Let $\boldsymbol{\nu}_n^I(\boldsymbol{\vartheta}_0)$ denote the first $J_I$ elements of $\boldsymbol{\nu}_n$ and  $\boldsymbol{\nu}_n^E(\boldsymbol{\vartheta}_0)$ the last $J_E$ elements.   
  ...
  \end{enumerate}
\item Determine which inequalities are far from binding: 
      \begin{enumerate}[(i)]
        \item define a selection matrix 
      \end{enumerate}
    \item Simulate the sampling distribution of $T_n(\boldsymbol{\vartheta}_0)$ under the null: 
      \begin{enumerate}[(i)]
        ...
        \item For each $r = 1, \hdots, R$ set $\boldsymbol{\xi}_r(\boldsymbol{\vartheta}_0) = \widehat{\Omega}_n^{1/2}(\boldsymbol{\vartheta}_0)\,\boldsymbol{\zeta}_r $.
        \item Let $\boldsymbol{\xi}_r^I(\boldsymbol{\vartheta})$ denote the first $J_I$ elements of $\boldsymbol{\xi}_r$ and $\boldsymbol{\xi}_r^E(\boldsymbol{\vartheta})$ denote the last $J_E$ elements.
      \end{enumerate}
