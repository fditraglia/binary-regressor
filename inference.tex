...
\todo[inline]{Collect full set of $h$ moments. Then state a theorem: given iid $\mathbf{w}_i$ and standard regularity conditions under the null we have $\sqrt{n}\, \bar{m}_n\left( \boldsymbol{\vartheta}_0, \widehat{\boldsymbol{\tau}}(\boldsymbol{\vartheta}_0) \right) = (MATRIX) \sqrt{n}(\text{All moments including h evaluated at theta0,tau0}) + o_p(1)$}
