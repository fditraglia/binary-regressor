...
\right]
\]
where $B^I$ is evaluated at $(\boldsymbol{\vartheta}_0, \mathbf{q}_0)$ and $B^E$ at $(\boldsymbol{\vartheta}_0, \boldsymbol{\gamma}_0)$.
\label{lem:prelim}
\end{lem}
...
$\widehat{\boldsymbol{\tau}}_0' = \big( \widehat{\boldsymbol{\gamma}}'(\boldsymbol{\theta}_0), \widehat{\mathbf{q}}'(\boldsymbol{\theta}_0) \big)$.
...
with
\begin{equation}
  \Xi(\boldsymbol{\vartheta}_0, \boldsymbol{\tau}_0) = \left[
  \begin{array}{cc}
    \mathbf{I} & B(\boldsymbol{\vartheta}_0, \boldsymbol{\tau}_0)
  \end{array}
\right], \quad
  B(\boldsymbol{\vartheta}_0, \boldsymbol{\tau}_0)= \left[
\begin{array}{cc}
  \mathbf{0} & \mathbf{0}\\
  B^I & \mathbf{0}\\
  \mathbf{0} & B^E
...
\right]
\end{equation}
where $B^I$ and $B^E$ are defined in Lemma \ref{lem:prelim}.
...
\begin{equation}
  \widehat{\Sigma}_n(\boldsymbol{\vartheta}_0) \equiv \Xi(\boldsymbol{\vartheta}_0, \widehat{\boldsymbol{\tau}}_0)\, \widehat{\mathcal{V}}_n(\boldsymbol{\vartheta}_0)\,\Xi'(\boldsymbol{\vartheta}_0, \widehat{\boldsymbol{\tau}}_0)
\end{equation}
where
\begin{equation}
\widehat{\mathcal{V}}_n(\boldsymbol{\vartheta}_0) \equiv \frac{1}{n} \sum_{i=1}^n
\left[
\begin{array}{c}
...
\begin{alg}[GMS Test for $(\alpha_0, \alpha_1)$ ]
  Give the full description of the asymptotic test of $H_0\colon \boldsymbol{\vartheta} = \boldsymbol{\vartheta}_0$, including drawing the normal simulations, etc, referencing the calculations and definitions from the preceding sections.
\end{alg}

\begin{alg}[Full inference procedure] \mbox{}
  \begin{enumerate}
