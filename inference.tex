...
\todo[inline]{Should add at least a couple of sentences about how Bonferroni relates to the IV interval: in particular it only excludes zero if the CI for $\theta_1$ excludes zero.}
...
\subsection{Incorporating Continuous Covariates}
\label{sec:covariates}

\todo[inline]{Flesh out the following outline: should only be a paragraph or so}
\begin{itemize}
