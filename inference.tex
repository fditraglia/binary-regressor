...
\item Construct the moment selection matrix $\Phi$.
    ...
    \item Simulate the sampling distribution of $T_n(\boldsymbol{\vartheta}_0)$ under the null. 
      \begin{enumerate}[(i)]
        \item Set $\widehat{\Omega} = \left[ \mbox{diag}\left\{\widehat{\Sigma}_n(\boldsymbol{\vartheta}_0)\right\} \right]^{-1/2}\left[\widehat{\Sigma}_n(\boldsymbol{\vartheta}_0)\right]\left[ \mbox{diag}\left\{\widehat{\Sigma}_n(\boldsymbol{\vartheta}_0)\right\} \right]^{-1/2}$.
