# Compared to molinari_critical_level2.R, this version re-parameterizes to
# eliminate the ratio b / (1 - a1). As in the earlier version, we assume that
# is known and equal to zero and hence preliminary estimation.
# Like the other version, this script uses only first moment so that
...
#sim_CIs <- t(sim_CIs)
#save(sim_CIs, file = "molinari_CIs.RData")
#rm(list = ls())
