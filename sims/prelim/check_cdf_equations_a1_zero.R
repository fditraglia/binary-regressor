...
dat <- binDGP(0.25, 0, n = 1000000, b = 1)
...
MC_a1_zero <- function(b, tau1, tau2){
  term1 <- (D1(tau1 + b) - D1(tau1) + D(tau1)) / D(tau1 + b)
  term2 <- (D1(tau2 + b) - D1(tau2) + D(tau2)) / D(tau2 + b)
  return(term1 - term2)
}
