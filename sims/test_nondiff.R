...
a1_true <- 0.2
b_true <- 1
dat <- dgp(a0_true, a1_true, b_true, n = 2000)
...
system.time(pvalues_nondiff <- get_p_values(alphas, GMS_test_alphas_nondiff,
                                            normal_sims))
system.time(pvalues_weak <- get_p_values(alphas, GMS_test_alphas,
