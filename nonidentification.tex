...
\begin{pro}[Lack of Identification]
  ...
  Then regardless of how many values $z$ takes on, $\beta$ is unidentified based on the observables contained in Table \ref{tab:observables}.
\end{pro}
...
\todo[inline]{Notice that Equation 20 breaks if $p_k = \alpha_0$. This is because it would reduce the pair of equations to an expression  kill the $m^*_{1k}$ term in the pair of equations for this particular value of $k$. }
