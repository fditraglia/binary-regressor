...
\todo[inline]{Add discussion of Mahajan's proof. In particular, explain why he needs there to be a first stage!}
...
\todo[inline]{Notice that Equation 20 breaks if $p_k = \alpha_0$. This is because it would reduce the pair of equations to an expression  kill the $m^*_{1k}$ term in the pair of equations for this particular value of $k$. This seems to be related to \cite{Hausman}}

\todo[inline]{Add some discussion of what this proof means, why there is a lack of identification intuitively, why adding more values for the instrument doesn't help, etc.}
