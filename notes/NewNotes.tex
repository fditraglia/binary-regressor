...
\begin{align*}
  ...
  &= \sigma_\varepsilon^2 + 2\beta q p_1^*(1-p_1^*)\left( m_{11}^* - m_{01}^* \right) + \beta^2 q p_1^*(1-p_1^*) \\
...
\todo[inline]{All that remains is to plug in. There appears to be a major simplification of the AVAR for the slope coefficient when $q = 1/2$ since the second term vanishes in that case. Or maybe I made a mistake in the algebra!}
