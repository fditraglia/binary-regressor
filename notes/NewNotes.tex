...
\begin{align*}
  ...
  \left[
  \begin{array}{cc}
    \mathbf{0}_k' & M(\tau_0)\left\{ H(\tau_0)'\Xi H(\tau_0)\right\}^{-1} H'(\tau_0)\Xi 
  \end{array}
\right] \right\}
\left[
\begin{array}{c}
...
\begin{array}{cc}
  \mathbf{0}'_k & B(\tau_0)
\end{array}
\right]\right\} \sqrt{n}\; \bar{g}_n(\tau_0)
\end{align*}
where $\mathbf{0}'_k$ is a $1\times k$ vector of zeros and $B(\tau_0) = M(\tau_0)\left\{ H(\tau_0)'\Xi H(\tau_0)\right\}^{-1} H'(\tau_0)\Xi$.
...
\[
  \sqrt{n}\; \bar{m}_n\left( \theta_0, \widehat{\tau}_n(\theta_0) \right) = \left\{ \mathbf{I} - \left[
  \begin{array}{cc}
    \mathbf{0}_k' & B\left( \theta_0, \tau(\theta_0) \right) 
\end{array}
\right]\right\} \; \sqrt{n}\; \bar{g}_n\left( \theta_0, \tau(\theta_0) \right)
\]
