...
\todo[inline]{Update from here down! I think $H$ will be different, and there will be some extra derivatives in $M$. Don't forget that we've included $\kappa_1$ among the pre-estimated parameters, so we need to put in the derivatives. These will all be zero but the notation is simpler this way. We also need to make sure that everything is arranged in the correct order.}
