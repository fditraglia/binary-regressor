...
\begin{align*}
  ...
  &= \left( \frac{1}{1 - \alpha_1} \right)^3 \left[ 2\beta C D - \beta^2 C^2 + 2\beta C^2 - 2\beta CD  \right]\\
  &= \frac{\beta^2 \mbox{Cov}(z,T)}{(1 - \alpha_1)^3} = \left( \frac{\beta}{1 - \alpha_1} \right)^2 \left[\frac{\mbox{Cov}(z,T)}{1 - \alpha_1}\right]
\end{align*}
Thus,
\begin{align*}
  G_\theta^{-1} &= \frac{(1 - \alpha_1)^3}{\beta^2 \mbox{Cov}(z,T)} 
  \left[
  \begin{array}{cc}
...
\right] \\ \\
  &=\left[
  \begin{array}{cc}
    \displaystyle (1 - \alpha_1)\left\{ 1 - \frac{2\mbox{Cov}(yT,z)}{\mbox{Cov}(z,T)} \right\}& \displaystyle  \frac{1 - \alpha_1}{\beta} \\ \\
    \displaystyle \frac{2(1 - \alpha_1)^2}{\beta}\left\{ \frac{\mbox{Cov}(yT,z)}{\beta\mbox{Cov}(z,T)} - 1 \right\} & \displaystyle -\left( \frac{1 - \alpha_1}{\beta} \right)^2
  \end{array}
\right] \\
\end{align*}
...
\begin{align*}
  ...
  \mathbb{E}\left[ f(\mathbf{w}_i;\theta_0, \gamma_0)f(\mathbf{w}_i;\theta_0, \gamma_0)' \right]\\
  &=\mathbb{E}
  \left[
  \begin{array}{cc}
