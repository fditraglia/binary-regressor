...
\section{June 1--2, 2017 -- Second Moment Bounds}
...
\]
so we see that $p_k$ is the smaller root if and only if $\sigma_{0k}^2<\sigma_{1k}^2$.
...
\end{eqnarray*}
\todo[inline]{It's not obvious to me that we can say for sure that $\sigma_{0k}^2 < \sigma_{1k}^2$ so I think it's possible that even if $\mu_{1k} = \mu_{0k}$ the 2nd moment inequality gives a strictly tighter bound. I also need to add an explanation of what would be required for $\mu_{1k} = \mu_{0k}$: we would need both $\beta=0$ and no endogeneity.}
