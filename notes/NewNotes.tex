...
\todo[inline]{Re-derive using more familiar expressions via the alternative definition of independence $P(Y|T^*,Z) = P(Y|T^*)$, work through the algebra to actually solve the quadratics, and express in a more general form that allows for continuous $Y$.}
