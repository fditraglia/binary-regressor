...
\begin{align*}
  \mathbb{E}\left[y^2(1 - p_0 - \alpha_1)\left\{ (1 - \alpha_1) - T \right\}(1 - z)   - \frac{\left\{ (1 - \alpha_1)\mu_{00} - \alpha_1 \mu_{10} \right\}^2}{p_0(1-p_0)(1-q)} \right] &> 0 \\
   \mathbb{E}\left[y^2(1 - p_1 - \alpha_1)\left\{ (1 - \alpha_1) - T \right\}z   - \frac{\left\{ (1 - \alpha_1)\mu_{01} - \alpha_1 \mu_{11} \right\}^2}{p_1(1-p_1)q} \right]&> 0 
\end{align*}
\todo[inline]{Need to check these!}
