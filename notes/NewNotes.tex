...
Rearranging,
\[
  \frac{p_k\left[ F_{1k}(\tau + \beta) - F_{1k}(\tau) \right] - p_\ell \left[ F_{1\ell}(\tau+ \beta) - F_{1\ell}(\tau) \right]}{F_k(\tau) - F_\ell(\tau)}  = 1 - \alpha_1
\]
Evaluating at two value of $\tau$, $\tau_1$ and $\tau_2$, and equating, we find
  \footnotesize
\[
  \frac{p_k\left[ F_{1k}(\tau_1 + \beta) - F_{1k}(\tau_1) \right] - p_\ell \left[ F_{1\ell}(\tau_1+ \beta) - F_{1\ell}(\tau_1) \right]}{F_k(\tau_1) - F_\ell(\tau_1)}  = \frac{p_k\left[ F_{1k}(\tau_2 + \beta) - F_{1k}(\tau_2) \right] - p_\ell \left[ F_{1\ell}(\tau_2+ \beta) - F_{1\ell}(\tau_2) \right]}{F_k(\tau_2) - F_\ell(\tau_2)} 
\]
\normalsize
\end{document}
