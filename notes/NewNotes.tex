...
\[
  \frac{\partial}{\partial \boldsymbol{\theta}'} \left[ \frac{\mathbf{b}(\boldsymbol{\theta})'\mathbf{c}}{\sqrt{\mathbf{b}(\boldsymbol{\theta})'\mathbf{M}\mathbf{b}(\boldsymbol{\theta})}} \right]
  = \underbrace{\frac{\partial}{\partial \boldsymbol{\theta}'} \mathbf{b}(\boldsymbol{\theta})}_{(r\times d)}
\]
\end{document}
