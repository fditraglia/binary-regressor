...
Now, from the proof of Proposition \ref{pro:eta2}, we have
\begin{align*}
...
\end{align*}
Using these equalities it follows, after some algebra, that
\begin{align*}
  \tau_2 %&= \mbox{Cov}\left[ (c + \varepsilon)^2 T, z \right] + 2 \beta \mbox{Cov}\left[ (c + \varepsilon)T^*,z \right] + \beta^2 \mbox{Cov}(TT^*,z)\\
  ...
  &= \left[(c + \beta)(1 - \alpha_1) - c \alpha_0\right] \mbox{Cov}(T^*,z) + (1 - \alpha_0 - \alpha_1) \pi^*
\end{align*}
where we use the shorthand $\pi^*$ to denote $\mbox{Cov}(T^*,z)$.
...
\]
from which it follows that $\mbox{Cov}(T\varepsilon^2,z) = (1 - \alpha_0 - \alpha_1)\mbox{Cov}(T^*\varepsilon^2,z)$, as required.
