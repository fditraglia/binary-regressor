...
\todo[inline]{Some discussion of how the cases will work.}

\paragraph{Case I: $0 < r_{tk} < 1$} 
Define
\begin{align*}
...
Suppose first that $\mu_{tk}$ does \emph{not} lie in the interval $[\underline{m}_{tk}, \overline{m}_{tk}]$.
...
\[
  ...
  \mu_{tk} = \int \tau F^{1}_{tk}(d\tau), \quad 
  \overline{m}_{tk} = \int \tau\overline{F}_{tk}^1(d\tau)
\]
so we have $\underline{m}_{tk} \leq \mu_{tk} \leq \overline{m}_{tk}$ which contradicts $\mu_{tk} \notin [\underline{m}_{tk}, \overline{m}_{tk}]$.

Now suppose that $\mu_{tk} \in \left[\underline{m}_{tk}, \overline{m}_{tk} \right]$.
...
Thus, there exists a $\xi^*$ such that $m_{tk}(\xi^*) = \mu_{tk}$.
