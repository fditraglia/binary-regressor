...
\end{align*}
Now, by Assumptions \ref{assump:model} (iii) and \ref{assump:2ndMoment}  $\mbox{Cov}(\varepsilon,z) = \mbox{Cov}(\varepsilon^2,z) = 0$, and by Assumption \ref{assump:misclassification} (ii) and (iii) $\mbox{Cov}(TT^*,z) = (1 - \alpha_1)\mbox{Cov}(T^*,z)$ and $\mbox{Cov}(T^*,z) = \pi/(1 - \alpha_0 - \alpha_1)$.
Hence, 
\begin{align*}
...
\end{align*}
But by Assumption \ref{assump:model} (iii), $\mathbb{E}[\varepsilon|z=k] = m_{1k}^*p_{k}^* + m_{0k}^*(1 - p_k^*)=0$.
Thus we see that $m_{0k}^*(1 - p_k^*)= - m_{1k}^* p_k^*$.
