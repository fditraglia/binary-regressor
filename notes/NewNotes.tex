...
\end{align*}
and, using the fact that $p_k^* = (p_k - \alpha_0)/(1 - \alpha_0 - \alpha_1)$,  
\begin{align*}
...
\end{align*}
Substituting the preceding expressions into those for $\pi^*_{11}(y)$ and $\pi^*_{00}(y)$ and 


\todo[inline]{Do the expressions for the always and never-takers yield an additional bound?}
