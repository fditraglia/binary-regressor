...
To obtain them from the CDF bounds either simply choose a $\tau$ that is strictly greater than or equal to all of the observed $y_i$ and pre-multiply by $\mathbf{1}(y_i \leq \tau)$ or choose a $\tau$ that is strictly \emph{less} than all of the observed $y_i$
