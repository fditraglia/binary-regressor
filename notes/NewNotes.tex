...
\todo[inline]{Need to correct the notation for this part!}
\begin{align*}
  m &=\frac{p-\alpha_{0}}{1-\alpha_{0}-\alpha_{1}}\left[\frac{(1-\alpha_{1})(1-p)-\alpha_{1}p}{p(1-p)}\right]\\
...
\todo[inline]{These are basically correct but when we wrote them we didn't realize that you don't get an extra equation from OLS. In our derivation we assumed that $z$ was an instrument but in Lewbel's case this isn't correct: he doesn't assume that the instrument-like-variable is excluded.}
