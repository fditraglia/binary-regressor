...
Accordingly, the present argument builds on the proof of Theorem \ref{thm:sharpI} given above.
Under Assumption \ref{assump:model} (i), Assumption \ref{assump:misclassification} (iii) is equivalent to $\mathbb{E}[y|z,T,T^*] = \mathbb{E}[y|z,T^*]$.
