...
Our first step relies on the fact that Assumptions \ref{assump:model} (ii) and \ref{assump:misclassification} (i)--(ii) constrain only the distribution of $(T,T^*,z)$.
Under these assumptions, we show how to construct a valid joint distribution for $(T,T^*,z)$ that is compatible with the observed distribution of $(T,z)$ for any $(\alpha_0,\alpha_1)$ satisfying $\alpha_0 \leq p_k \leq 1 - \alpha_1$.
Our second step shows 
...
\todo[inline]{Also need to show that it agrees with the observed joint distribution of $(T,z)$ which, of course, can be factorized as $p(T,z) = p(T|z)p(z)$.}
