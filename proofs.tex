...
\todo[inline]{Add introductory paragraph explaining that this proof relies on the proof of Theorem \ref{thm:sharpI}. All that we prove here is a characterization of the additional information provided by the non-differential assumption. Explain how this builds on what we have to further restrict $\alpha_0, \alpha_1$ but why it doesn't restrict anything else.}
