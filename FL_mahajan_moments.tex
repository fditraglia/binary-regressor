...
Inference based on the moment equalities from Equation \ref{eq:MCs_exog} suffers from the same difficulties as that based on Equation \ref{eq:MCs_endog} above.
