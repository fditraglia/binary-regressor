...
First consider the case in which $T^*$ is exogenous, so that $E(T^*u)=0$, and $z$ is binary.
...
\todo[inline]{I think this will make things easier to solve because we could treat the quantity $\left[ E(T|z=1)-\alpha_0 \right]m_{11}$ as a unit and eliminate it from the system. But I could be wrong\dots}
