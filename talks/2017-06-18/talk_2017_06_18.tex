...
\end{align*}
  ...
  \begin{alertblock}{Theorem}
    Suppose that $\theta_1(\mathbf{x}), \theta_2(\mathbf{x})$ and $\theta_3(\mathbf{x})$ are identified.
    Then:
    \begin{itemize}
      \item $\theta_1(\mathbf{x})\neq 0 \implies \beta(\mathbf{x}), \alpha_0(\mathbf{x})$ and $\alpha_1(\mathbf{x})$ are identified 
      \item $\theta_1(\mathbf{x}) = 0 \implies \beta(\mathbf{x})$ is identified but $\alpha_0(\mathbf{x})$ and $\mathbf{\alpha}_1(\mathbf{x})$ are not.
    \end{itemize}
  \end{alertblock}
