...
\begin{frame}
  ...
  \small
  \[\mathcal{W} =  \frac{\beta}{1 - \alpha_0 - \alpha_1},
...
\begin{block}{If $\alpha_0 + \alpha_1 < 1$, then:}
  \begin{itemize}
    ...
    \item $\beta$ has same sign as $\mathcal{W}$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  Picture / example of using CDF conditions?
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  Picture / example of using CDFs to get identification?
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
