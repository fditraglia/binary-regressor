...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Generalized Moment Selection: Andrews \& Soares (2010)}

  \small

  \begin{block}{Moment Selection Step}
    \vspace{0.4em}
    If $\boxed{\displaystyle\frac{\sqrt{n}\,\bar{m}_{n,j}(\vartheta_0)}{\widehat{\sigma}_{n,j}(\vartheta_0)} > \sqrt{\log n}}$, ignore ineq.\ $j$ when calculating critical value.
  \end{block}
