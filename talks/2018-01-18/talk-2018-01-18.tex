...
\begin{frame}
  ...
  \begin{block}{Generalized Moment Selection -- Andrews \& Soares (2010)}
    \begin{itemize}
      ...
      \item Specifically: drop inequality $j$ if  $\alert{\displaystyle\frac{\sqrt{n}\,\bar{m}_{n,j}(\vartheta_0)}{\widehat{\sigma}_{n,j}(\vartheta_0)} > \sqrt{\log n}}$
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  Simple example with a simulated dataset.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
\begin{frame}[noframenumbering,plain]
  ...
  \begin{block}{DiTraglia \& Lewbel (in progress)}
    What if $T$ can affect on $y$ \emph{separately} from $T^*$? (E.g.\ higher wage by claiming to have college degree.) 
