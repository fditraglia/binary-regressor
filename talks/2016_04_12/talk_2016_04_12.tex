...
\begin{frame}
  ...
  \begin{block}{Reasonable?}
    Makes sense in an RCT or a natural experiment.
  \end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{But What if $z$ is Endogenous?}
  \begin{itemize}
    \item Partial Identification with Invalid Instrument
      \begin{itemize}
        \item {\footnotesize Conley et al.\ (2012), Nevo \& Rosen (2012), Kraay (2012)} 
      \end{itemize}
    \item Mis-classification, Treatment Endogeneity
    \item Bayesian Analysis of Partially Identified Models
  \end{itemize}
