...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg45.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg30.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg20.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg19.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg18.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg17.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg16.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg15.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg14.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg13.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg12.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg10.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg06.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[h]
  ...
  \tikzset{every picture/.style={scale=0.53}}
  \centering
  \input{../../../sick-instruments/fig/AngristBettinger/dTstar_neg00.tex}
  \endgroup
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  ...
  \begin{block}{Structural Parameters $(\delta_{T^*}, \delta_z, \alpha_0, \alpha_1)$}
    \begin{itemize}
      ...
      \item E.g.\ $\alpha_0, \alpha_1 \sim \mbox{ iid } U(0, 0.25) \perp \delta_{T^*}\sim U(-0.5, -0.1)$
    \end{itemize}
  \end{block}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale = 0.6]{../../../sick-instruments/fig/AngristBettinger/BlueBar.pdf}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Implications for Beta} 
  \framesubtitle{Compare to IV Estimate of $-0.1$, SE $0.04$}
\begin{figure}[h]
  \centering
  \includegraphics[scale = 0.42]{../../../sick-instruments/fig/AngristBettinger/TwoHistograms.pdf}
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  ...
  \begin{block}{Valid Instrument}
    ...
    \end{itemize}
  \end{block}
  \begin{block}{Potentially Invalid Instrument}
    \begin{itemize}
      \item Partial Identification Framework
      \item Incorporate beliefs, check that they are mutually consistent.
      \item Inference incorporating beliefs: Bayesian or Frequentist
      \item Can be very informative in applications
    \end{itemize}
  \end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
