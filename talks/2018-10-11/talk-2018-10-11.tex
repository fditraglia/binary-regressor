...
\begin{frame}
  ...
  \note{\singlespacing\scriptsize
    \begin{itemize}
      ...
      \item So far just notation.
        Now impose some restrictions.
        First: conditional on x, the mis-classification rates do not depend on z. This is not an innocuous assumption. Give an example when it holds and when it doesn't. Nearly impossible to make any progress without this assumption. How reasonable it is depends on the choice of conditioning variables x.
