...
\begin{frame}
  ...
  \note{\singlespacing\tiny
    ...
    \begin{itemize}
      ...
      \item Second: $Cor(T,T^*)>0 \equiv \alpha_0 + \alpha_1 < 1$. Mild assumption. I'll say more in a few slides.
      \item Third: \emph{non-diff} assumption. Stated in terms of epsilon, but intuitively what this really says is that the conditional mean of Y does not depend on T after controlling for x, z, and T*. Like the first of the measurement error assumptions, the plausibility of this assumption depends on the situation and also the controls included in x.
\item An example of what non-differential measurement error rules out is "returns to lying." For example, suppose Y is log wage, T* is the true indicator for whether you graduated from college, and z is an instrument for college attendance. If T is an individual's *self-report*. hether you had a college degree,  which is incidentally the topic of a paper I'm currently writing with Arthur Lewbel.
    \end{itemize}
  }%
