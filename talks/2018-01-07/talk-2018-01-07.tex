...
\begin{frame}
  ...
  \begin{alertblock}{Theorem}
    Under the baseline assumptions, the sharp identified set for $\beta(\mathbf{x})$ is never a singleton, regardless of how many (discrete) values the instrument $z$ takes on.
  \end{alertblock}

  \vspace{2em}
  \begin{block}{Point identification from slightly stronger assumptions?}
  \end{block}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%      \hyperlink{SHARP_APPEND}{\beamergotobutton{Overview}}
%    %\item Description of the sharp set is more complicated 
...
\begin{frame}
 ...
 \item Endogenous Mis-classification: ``returns to lying''
 \end{itemize}
 \end{block}
...
%  \hyperlink{SHARP_BODY}{\beamergotobutton{Back}}
%  \end{block}
%
%
%
